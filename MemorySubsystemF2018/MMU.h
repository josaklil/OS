...
/**
   ...
   */
  bool get_byte(void *dest, Addr vaddress);
   ...
   * @return true if success, false if operation aborted by fault handler
   */
  bool get_bytes(void *dest, Addr vaddress, Addr count);
   ...
   * @return true if success, false if operation aborted by fault handler
   */
  bool put_byte(Addr vaddress, void *src);
   ...
   * @return true if success, false if operation aborted by fault handler
   */
  bool put_bytes(Addr vaddress, Addr count, void *src);
